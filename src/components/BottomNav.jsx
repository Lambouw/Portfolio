...
const BottomNav = () => {
  ...
  const navItems = [
    { id: "home", label: "Home", onClick: scrollToTop, icon: <HomeIcon /> },
    {
      id: "about",
      label: "About",
    ...
    },
    {
      ...
      icon: <FontAwesomeIcon icon={faLaptopCode} size="lg" />,
    },
    {
      id: "experience",
      label: "Experience",
  ...
  return (
    <div className="bottomnav">
      {navItems.map((item) => (
        <div key={item.id} className="bottomnav--item" onClick={item.onClick}>
          <div className="bottomnav--item--icon">{item.icon}</div>
        </div>
      ))}
      <div
        className="bottomnav--item bottomnav--item--theme-toggler"
