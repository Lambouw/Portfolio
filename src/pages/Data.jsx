  ...
  return (
    <div className="data">
      ...
      <div className="data--container">
        <h1 className="data--container--title">Privacy Policy</h1>
        <div className="height-m"></div>
        <h3>1. Allgemeine Hinweise und Pflichtinformationen</h3>
        <div className="height-s"></div>
        <p className="data--container--header">Datenschutz</p>
        ...
        <div className="height-s"></div>
        <p className="data--container--header">
        ...
        <div className="height-xs"></div>
        <p className="data--container--text">Maria Musterfrau</p>
        <p className="data--container--text">Loeweweg 1</p>
        <p className="data--container--text">71397 Leutenbach</p>
        <p className="data--container--text">Deutschland</p>
        <div className="height-xs"></div>
        <p className="data--container--text">
          E-Mail:&nbsp;
        ...
        <p className="data--container--header-small">
        ...
        <h2 className="data--container--header">
          2. Datenerfassung auf dieser Website
        </h2>
        <p className="data--container--header-small">Server-Log-Dateien</p>
        <p className="data--container--text">
        ...
        <p className="data--container--list">
          <ul>
        ...
        <p className="data--container--header-small">Kontaktformular</p>
        <p className="data--container--text">
        ...
        <h2 className="data--container--header">3. Hosting bei Strato</h2>
        <p className="data--container--text">
